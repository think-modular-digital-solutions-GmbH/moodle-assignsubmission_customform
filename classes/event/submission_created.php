...
/**
 * The assignsubmission_customform submission_created event.
 *
...
/**
 * The assignsubmission_customform submission_created event class.
 *
...
class submission_created extends \mod_assign\event\submission_created {
    ...
    protected function init() {
        parent::init();
        $this->data['objecttable'] = 'assignsubmission_customform';
    }
