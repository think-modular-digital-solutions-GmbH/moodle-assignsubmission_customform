...
/**
 * The assignsubmission_customform assessable uploaded event.
 *
...
namespace assignsubmission_customform\event;

/**
 * The assignsubmission_customform assessable uploaded event class.
 *
 * @package    assignsubmission_customform
 * @author     Stefan Weber <stefan.weber@think-modular.com>
 * @copyright  2025 think modular
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'assignsubmission_customform');
    }
